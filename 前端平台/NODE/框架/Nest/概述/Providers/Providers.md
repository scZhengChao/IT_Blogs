...
[服务service](服务service.md "服务service")

[依赖注入](IT/前端平台/NODE/框架/Nest/概述/Providers/依赖注入/依赖注入.md "依赖注入")

[作用域](IT/前端平台/NODE/框架/Nest/概述/Providers/作用域/作用域.md "作用域")

[自定义提供者](IT/前端平台/NODE/框架/Nest/概述/Providers/自定义提供者/自定义提供者.md "自定义提供者")

可选提供者

[可选提供者](可选提供者.md "可选提供者")

[基于属性的注入](基于属性的注入.md "基于属性的注入")

[注册提供者](注册提供者.md "注册提供者")

[手动实例化](手动实例化.md "手动实例化")
