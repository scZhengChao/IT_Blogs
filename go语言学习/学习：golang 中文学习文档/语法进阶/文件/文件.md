...
文件的查找路径\*\*默认为项目`go.mod`\*\***文件所在的路径，由于项目下并没有该文件，所以自然会返回一个错误。**
...
> 注意
> 打开**一个文件后永远要记得关闭该文件，通常关闭操作会放在defer语句里**
...
### [#](https://golang.xiniushu.com/语言入门/语法进阶/100.io.html#读取-1 "#")读取
