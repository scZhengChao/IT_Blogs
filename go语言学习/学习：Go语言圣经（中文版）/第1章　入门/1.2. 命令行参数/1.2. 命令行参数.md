...
[gopl.io/ch1/echo1](http://gopl.io/ch1/echo1 "gopl.io/ch1/echo1")
...
> 表达式的核心是 “计算并产生一个值”，它回答 “是什么”；
> 语句的核心是 “执行一个动作 / 操作”，它回答 “做什么”，不一定产生值（多数情况下不产生）。
...
**`for`**\*\* 循环的另一种形式，在某种数据类型的区间（range）上\*\*遍历，如字符串或切片。`echo` 的第二版本展示了这种形式：

[gopl.io/ch1/echo2](http://gopl.io/ch1/echo2 "gopl.io/ch1/echo2")
...
[gopl.io/ch1/echo3](http://gopl.io/ch1/echo3 "gopl.io/ch1/echo3")
...
**练习 1.3：** 做实验测量潜在低效的版本和使用了 `strings.Join` 的版本的运行时间差异。（[1.6 节](https://gopl-zh.github.io/ch1/ch1-06.md "1.6 节")讲解了部分 `time` 包，[11.4 节](https://gopl-zh.github.io/ch11/ch11-04.md "11.4 节")展示了如何写标准测试程序，以得到系统性的性能评测。）
