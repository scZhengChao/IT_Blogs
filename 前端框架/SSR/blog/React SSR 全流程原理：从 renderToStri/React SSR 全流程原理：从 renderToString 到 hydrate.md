...
![](image_RjSAocI8vT.png)

组件的话就传入参数执行：

![](image_U4_fG2kmRR.png)

元素的话就拼接字符串：

![](image_KY6UPB2_LZ.png)

![](image_zadgcBG9Ts.png)

这样递归渲染一遍，结果就是字符串了：

![](image_M4qMBqP4dp.png)
