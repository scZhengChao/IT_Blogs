...
![](image_SxeH3UM1qG.png)

![](image_JCvWqAxSCk.png)

![](image_wFrLBxrPMU.png)

`listenToNativeEvent`方法主要决定了**当前事件是否要捕获**，绑定实现在`addTrappedEventListener`。最终执行了addEventListener。

![](image_BNH4PTxTBE.png)

![](image_33lvoTdAuP.png)
...
![](image_3rnXh6Lpiz.png)

![](image_ZSYWMKl6-q.png)
