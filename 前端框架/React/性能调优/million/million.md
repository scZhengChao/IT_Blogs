...
![](image_j7c66rCqGe.png)

使用 Million 的打包体积：

![](image_hk50-y-6Zd.png)
...
![](image_yzugJPpH2p.png)

1. 现在开始静态分析，检查第一个节点是否有占位符，没有找到，继续下一步。

![](image_q6oJus7tfy.png)
