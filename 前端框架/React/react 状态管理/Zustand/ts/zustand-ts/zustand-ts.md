...
![](image_NE-_VA4CZo.png)

![](image_x-IvKOALy3.png)
...
![](image_R24X58U8pv.png)

因为函数上没有\$\$name属性，所以报错了，下面给函数加上属性就可以了

![](image_vXMhftoQVJ.png)
...
![](image_nmuoYZhzkN.png)

因为T对象中没有count属性，所以返回never，`never`表示不存在的类型。

![](image_bXR13zZ-KO.png)
...
![](image_rj3lksdH5v.png)

第二个重载方法有一个参数，可以返回自定义属性。

![](image_AH1yT8i9rf.png)

第三个重载方法废弃了，就不说了。

![](image_8Sc7DknxEU.png)
...
![](image_w9pGUGG4rG.png)

![](image_8jW8fzRKWg.png)
...
![](image_f3Vy_TCIMj.png)

在中间件中也可以重写setState方法

![](image_Sf_L7yhahi.png)

![](image_0VaXAlbQ09.png)
