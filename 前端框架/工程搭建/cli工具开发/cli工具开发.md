...
![](image_ZkRan9Ldxb.png)

![](image_Te_wNd9KUO.png)

## 代码

[app-cli.zip](app-cli_6TwafHUhWD.zip " app-cli.zip")

或者

[vue-auto-router-cli.zip](vue-auto-router-cli_jeVmRxHdoY.zip " vue-auto-router-cli.zip")
