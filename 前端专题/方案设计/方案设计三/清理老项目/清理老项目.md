...
![](image_Stj3C3MLv2.png)

![](image_l_ogsFx-pk.png)
...
[Demo.zip](Demo_f3PeA6pjTV.zip " Demo.zip")

[在源码中去除dead code\_副本](<在源码中去除dead code_副本.md> "在源码中去除dead code_副本")

[找到所有未被引用的文件\_副本](找到所有未被引用的文件_副本.md "找到所有未被引用的文件_副本")
