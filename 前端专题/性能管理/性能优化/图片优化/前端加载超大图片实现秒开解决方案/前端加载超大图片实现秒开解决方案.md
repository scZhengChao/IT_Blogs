...
- [1 图像切片原理介绍](#1-图像切片原理介绍)
- [2 实现](#2-实现)
- [3 上传打开图形](#3-上传打开图形)
- [4 应用案例](#4-应用案例)
- [5 应用一 对图像进行拼接前端查看](#5-应用一-对图像进行拼接前端查看)
- [6 应用二 对 tiff 影像进行切片并与 CAD 图叠加校准](#6-应用二-对-tiff-影像进行切片并与-CAD-图叠加校准)

> **作者：程序员成长指北** [**查看原文**](http://mp.weixin.qq.com/s?__biz=MzUxNzk1MjQ0Ng==\&mid=2247515466\&idx=1\&sn=bffbe78643381468764ff013e85cb54a\&chksm=f992bb9bcee5328dc49eaf3d9f054ec732bfecb871bc9f4a4d6d887291ec76d4bace6358b201\&mpshare=1\&scene=1\&srcid=0730UbwB8lvzfepOuRboBX11\&sharer_sharetime=1690732231933\&sharer_shareid=26732caa83170683d9307abbbbf69ab9#rd "查看原文")
...
使用**图像切片可以降低处理大图像的复杂度，同时也能够提高图像的加载速度，使得用户可以更快地查看图像的细节**。图像切片广泛应用于**需要处理大图像的场景**，**能够提高图像处理和显示效率，同时也能够提高用户的体验。**

#### 2 实现

先上效果图

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/zPh0erYjkib3OuQfoM4riaeoNSxO6LlcEE6IS8UfMI5bracr3JEsm9THLDMxIibVBAZCtg2tPZSOWibWfaZKUNYAiag/640?wx_fmt=gif\&wxfrom=5\&wx_lazy=1\&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/meG6Vo0Mevj8JVEMtD7H0sWRKia7QpSDaLkkWg85UTt67aNO11udsMibV0ib9QpmL6bbwGlH0HnegKmkLSia9X0FzQ/640?wx_fmt=png)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/meG6Vo0Mevj8JVEMtD7H0sWRKia7QpSDa6pXPdIr5AOgD8Y3sWib6jrA0JZQzW5yCXVrp1tQ5SH6xVw5Pl7F4Mjg/640?wx_fmt=png)

最终效果为:

![](https://mmbiz.qpic.cn/sz_mmbiz_png/meG6Vo0Mevj8JVEMtD7H0sWRKia7QpSDaeplKdhPGkLD8tkGGicWpyQ8hp3HcjcOX2bG9iabR1Tdg8a38Ff0ibqbBg/640?wx_fmt=png)

体验地址：[https://vjmap.com/app/cloud/#/map/t3c93d14ff09?version=v1\&mapopenway=GeomRender\&vector=false](https://vjmap.com/app/cloud/#/map/t3c93d14ff09?version=v1\&mapopenway=GeomRender\&vector=false "https://vjmap.com/app/cloud/#/map/t3c93d14ff09?version=v1\&mapopenway=GeomRender\&vector=false")

#### 6 应用二 对 tiff 影像进行切片并与 CAD 图叠加校准
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/meG6Vo0Mevj8JVEMtD7H0sWRKia7QpSDaFIrb4ia0AyLlOnqppUv3ibqERcZBg8NDSXQ2PsXZUh1FKg0MuLJQ2enw/640?wx_fmt=png)

或者上传完后，操作菜单中点击设置地图范围进行设置

![](https://mmbiz.qpic.cn/sz_mmbiz_png/meG6Vo0Mevj8JVEMtD7H0sWRKia7QpSDabN8YDgvTDjsdIrjyMMM970fqBxA8qibSFVOOx0vBoPIHNstawicdzpYg/640?wx_fmt=png)

影像地图切片完成后，可与 CAD 图进行叠加校准。效果如下

![](https://mmbiz.qpic.cn/sz_mmbiz_png/zPh0erYjkib3OuQfoM4riaeoNSxO6LlcEEVUeD9zgW7eUMdvsFgELqIMcdTIHaBagobMTiah4RVDmDoPjP8icribUKg/640?wx_fmt=png\&wxfrom=5\&wx_lazy=1\&wx_co=1)

体验地址:[https://vjmap.com/demo/#/demo/map/comprehensive/04imagecadmap](https://vjmap.com/demo/#/demo/map/comprehensive/04imagecadmap "https://vjmap.com/demo/#/demo/map/comprehensive/04imagecadmap")
