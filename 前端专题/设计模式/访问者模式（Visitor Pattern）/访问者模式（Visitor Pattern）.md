...
[【设计模式27】访问者模式+源码分析：Eclipse JDT AST中浏览者模式](<【设计模式27】访问者模式+源码分析：Eclipse JDT AST中浏览者模式.md> "【设计模式27】访问者模式+源码分析：Eclipse JDT AST中浏览者模式")

[初探javascript设计模式-访问者模式](初探javascript设计模式-访问者模式.md "初探javascript设计模式-访问者模式")
