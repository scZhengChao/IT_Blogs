...
- [1、递归算法](#1递归算法)
  ...
  - [2 分治算法](#2-分治算法)
    - [2.1 算法策略](#21-算法策略)
    - [2.2 适用场景](#22-适用场景)
    - [2.3 使用分治法求解的一些经典问题](#23使用分治法求解的一些经典问题)
      - [二分查找](#二分查找)
  - [3 贪心算法](#3-贪心算法)
    - [3.1 算法策略](#31-算法策略)
    - [3.2 适用场景](#32-适用场景)
    - [3.3 经典案例：活动选择问题](#33-经典案例活动选择问题)
  - [4 回溯算法](#4-回溯算法)
    - [4.1 算法策略](#41-算法策略)
    - [4.2 适用场景](#42-适用场景)
    - [4.3 使用回溯算法的经典案例](#43-使用回溯算法的经典案例)
  - [5 动态规划](#5-动态规划)
    - [5.1 算法策略](#51-算法策略)
    - [5.2 适用场景](#52-适用场景)
    - [5.3 使用动态规划求解的一些经典问题](#53-使用动态规划求解的一些经典问题)
  - [6 枚举算法](#6-枚举算法)
    - [6.1 算法策略](#61-算法策略)
    - [6.2 解题思路](#62-解题思路)
...
最后，二分法***只能应用于数组有序的情况***，如果数组无序，二分查找就不能起作用了
