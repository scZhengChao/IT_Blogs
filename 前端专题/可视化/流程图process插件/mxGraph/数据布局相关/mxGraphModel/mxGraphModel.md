...
![](image_Hod2Ia0tX6.png)

[setGeometry](setGeometry.md "setGeometry")

[clear](clear.md "clear")

[getChildCount](getChildCount.md "getChildCount")

[getChildAt](getChildAt.md "getChildAt")

[getCell](IT/前端专题/可视化/流程图process插件/mxGraph/数据布局相关/mxGraphModel/getCell/getCell.md "getCell")
