...
[不需要在子应用的package.json里显示声明其他子包；也可以直接在子应用导入使用吗；原理是什么](不需要在子应用的package.json里显示声明其他子包；也可以直接在子应用导入使用吗；原理是什么.md "不需要在子应用的package.json里显示声明其他子包；也可以直接在子应用导入使用吗；原理是什么")
