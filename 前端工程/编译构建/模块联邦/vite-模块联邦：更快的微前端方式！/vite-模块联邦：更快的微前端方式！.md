...
- [模块联邦的核心优势](#模块联邦的核心优势)
- [如何实现](#如何实现)
  - [1、安装模块联邦插件](#1安装模块联邦插件)
    - [2、暴露组件
      ](#2暴露组件)
  - [3、加载远程组件](#3加载远程组件)
- [主应用与子组件关系图](#主应用与子组件关系图)
- [缺陷](#缺陷)
...
![](https://p9-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/e3a144ae6df6474ab1338529c0451f36~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg55-z5bCP55-zT3J6:q75.awebp?rk3s=f64ab15b\&x-expires=1749540571\&x-signature=8l17pn8JhemrwTtWjIa62RfSbC8%3D)

**为了解决不同服务之间组件共享的问题**，Webpack 的模块联邦功能应用而生。借助模块联邦，**可以在B服务运行时，动态加载A服务暴露的模块。**

Vite通过[vite-plugin-federation](https://link.juejin.cn/?target=https://github.com/originjs/vite-plugin-federation "vite-plugin-federation")插件也可以实现
...
相比 `qiankun` 等微前端方案，模块联邦在灵活性上更具优势。`qiankun` 侧重于加载整个子应用，而模块**联邦支持按需加载特定模块**，粒度更细，使用更灵活。
...
我们需要使用[vite-plugin-federation](https://link.juejin.cn/?target=https://github.com/originjs/vite-plugin-federation "vite-plugin-federation")插件。
...
```javascript title="ui-library/src/SharedButton.vue"
<template>
...
```typescript title="ui-library/vite.config.js"
