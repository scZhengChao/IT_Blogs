...
- [一、简介](#一简介)
- [二、限制选项](#二限制选项)
  - [2.1 资源加载限制](#21-资源加载限制)
  - [2.2 default-src](#22-default-src)
  - [2.3 URL 限制](#23-URL-限制)
  - [2.4 其他限制](#24-其他限制)
  - [2.5 report-uri](#25-report-uri)
- [三、Content-Security-Policy-Report-Only](#三Content-Security-Policy-Report-Only)
- [四、选项值](#四选项值)
- [五、script-src 的特殊值](#五script-src-的特殊值)
- [六、注意点](#六注意点)

[ CSP\_HTTP\_参考手册\_非常教程  http://www.verydoc.net/http/00004232.html](http://www.verydoc.net/http/00004232.html " CSP_HTTP_参考手册_非常教程  http://www.verydoc.net/http/00004232.html")

[ Content Security Policy 入门教程 - 阮一峰的网络日志  https://www.ruanyifeng.com/blog/2016/09/csp.html](https://www.ruanyifeng.com/blog/2016/09/csp.html " Content Security Policy 入门教程 - 阮一峰的网络日志  https://www.ruanyifeng.com/blog/2016/09/csp.html")

跨域脚本攻击 [XSS](https://baike.baidu.com/view/2161269.htm "XSS") 是最常见、危害最大的网页安全漏洞。

![](image_CTdlXsAiCX.png)
...
CSP 的**实质就是白名单制度**，开发者明确告诉客户端，**哪些外部资源可以加载和执行**，等同于提供白名单。它的**实现和执行全部由浏览器完成，开发者只需提供配置。**

CSP 大大增强了网页的安全性。攻击者即使发现了漏洞，也没法注入脚本，除非还控制了一台列入了白名单的可信主机。

两种方法可以启用 CSP。**一种是通过 HTTP 头信息的**\*\*`Content-Security-Policy`\*\***的字段。**

![](image_8307HvLpLC.png)
...
![](image_DhY1EyHLl2.png)

Firefox 的报错信息。

![](image_89kWh4YlH7.png)
...
`default-src`用来设置**上面各个选项的默认值**。

> Content-Security-Policy: default-src 'self'

上面代码限制**所有的外部资源，都只能从当前域名加载。**
...
> Content-Security-Policy: default-src 'self'; ...; report-uri /my\_amazing\_csp\_report\_parser;
...
> Content-Security-Policy: script-src 'self' [https://apis.google.com](https://apis.google.com "https://apis.google.com")
...
> Content-Security-Policy: script-src 'sha256-qznLcsROx4GACP2dm0UCKCzCG-HiZ1guq6ZZDob\_Tng='
...
[获取错误content-security-policy错误:拒绝创建worker](获取错误content-security-policy错误-拒绝创建worker.md "获取错误content-security-policy错误:拒绝创建worker")
