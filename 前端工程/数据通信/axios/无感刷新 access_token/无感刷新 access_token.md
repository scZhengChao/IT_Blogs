...
- [实现](#实现)
  - [方法介绍](#方法介绍)
- [优化](#优化)
  - [防止多次刷新 token](#防止多次刷新-token)
  - [同时发起多个请求的处理](#同时发起多个请求的处理)
...
![](https://mmbiz.qpic.cn/mmbiz_png/YBFV3Da0NwsoLlKsVeInJoqHpbhyOIibyWTAI2ygC6bCQG5jDTlAWCu3VretWrT1S2BzcnvQDbqy38emtbjgjicQ/640?wx_fmt=png\&wxfrom=5\&wx_lazy=1\&wx_co=1)
