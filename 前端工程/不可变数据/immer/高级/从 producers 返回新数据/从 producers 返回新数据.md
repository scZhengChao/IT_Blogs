...
- [使用nothing产生undefined](#使用nothing产生undefined)
- [使用void的内联快捷方式](#使用void的内联快捷方式)
...
但是，为了让 Immer 清楚您有意生成`undefined`值，您可以**返回内置标记**`nothing`：
...
在这种情况下，您可以使用 javascripts[void](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/void "void")运算符 \*\*，它计算表达式并返回`undefined`。\*\*​
