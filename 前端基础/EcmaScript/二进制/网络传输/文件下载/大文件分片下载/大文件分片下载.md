...
![](image_GYAdBMmjQR.png)

可以看到，触发了下载。

在 devtools 里可以看到正确设置了 header：

![](image_6nhEpUwfGX.png)
...
![](image_B1zom0nCf9.png)

![](image_LK2B0s_5uy.png)
...
![](image_4d3t1XM2kE.png)

![](image_ctDzTSHFF7.png)

效果一样。

只是这里的 Content-Type 默认是 application/octet-stream 二进制流：

![](image_wK2Mm8bNsY.png)
...
![](image_UUEjUySb_M.png)

安装后把它跑起来：

![](image_t3OROdlyW1.png)

选择 loopback 这个网卡，本地回环地址，可以抓到 localhost 的包：

![](image_lmCmDhYN28.png)

输入过滤器 port 3000，也就是过滤 3000 端口的数据包。

然后回车就会进入抓包界面：

![](image_gKi2x06-0G.png)
