...
![  ](50e165c24138569bacbfbf7d1a6b5e1f_5eFc2TCIHJ.png "  ")

## **二进制相关数据类型**

在介绍常见的二进制数据处理之前，先简单介绍下几种二进制相关的数据类型

[ArrayBuffer && TypedArray](<ArrayBuffer && TypedArray.md> "ArrayBuffer && TypedArray")

[Blob](IT/前端基础/EcmaScript/二进制/Blob/Blob.md "Blob")

[数据输入输出](数据输入输出.md "数据输入输出")
...
[FileReader](FileReader.md "FileReader")
