...
![  ](1679823-dea0e956685154e5_3WIFApk0UE.png "  ")

2009年，W3C提出了一种新的方案--Flex布局，可以简便、完整、响应式地实现各种页面布局。目前已得到所有现在浏览器的支持。

![  ](1679823-909f698a8d82fbc4_Y75HEvnsCW.jpg "  ")
...
![  ](1679823-6ea441649bdf542a_wKggYHw3i6.png "  ")
...
[父元素属性](父元素属性.md "父元素属性")

[子元素的属性](子元素的属性.md "子元素的属性")
