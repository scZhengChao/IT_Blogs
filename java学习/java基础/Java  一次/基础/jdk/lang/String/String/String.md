...
![](image_yOFAKfLZfB.png)

&#x20;&#x20;

> 每个字节**是8位；是不能超过127的；中文转换为字节后超过了127；发生了溢出；以负数的形式显示**；

![](image_3xIa2rvjEV.png)

![](image_mr7tvM4LEs.png)
...
![](image_O-rdHjZU2v.png)

![](image_-dY7f6-XYK.png)
