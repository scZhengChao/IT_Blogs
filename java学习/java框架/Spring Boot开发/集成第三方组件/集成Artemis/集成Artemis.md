...
ActiveMQ Artemis是一个JMS服务器，在[集成JMS](https://liaoxuefeng.com/books/java/spring/integration/jms/index.html "集成JMS")一节中我们已经详细讨论了如何在Spring中集成Artemis，本节我们讨论如何在Spring Boot中集成Artemis。
