...
[longList.html](./file/longList_NO3WQEsURs.html "longList.html")

这个文件有个严重的问题；会反复触发**IntersectionObserver监听；没有解决**

**最后看下作者源码**：

[listScroll-master.7z](./file/listScroll-master_omu7uRgywq.7z "listScroll-master.7z")

看了作者源码后修改的：

[longList.html](./file/longList_JHjQUnEQ7I.html "longList.html")
