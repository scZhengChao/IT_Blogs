...
![](./image/image_XTpA_MjRUt.png)

![](./image/image_01VLplKjrr.png)
...
![](./image/image_Dll_E4Da9h.png)

**（2）middle对齐：**指元素的垂直中心**线与父级基线往上二分之一X所在的位置的线对齐。有点绕，看下图：**

![](./image/image_8eeRwy47gP.png)
...
![](./image/image_GXs-brLj8H.png)

接着，我们再用一个`inline-block`化的span标签将文字包裹并设置文字背景色。如下：

![](./image/image_FFvtezZZka.png)
