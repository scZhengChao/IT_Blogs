...
- [为何选用 shape-outside](#为何选用-shape-outside)
  - [shape-outside 核心概念](#shape-outside-核心概念)
    - [shape-outside 可接受的值](#shape-outside-可接受的值)
  - [解决痛点问题](#解决痛点问题)
- [shape-outside 使用示例](#shape-outside-使用示例)
  - [示例1：环绕圆形图片的文本](#示例1环绕圆形图片的文本)
  - [示例2：自定义多边形路径环绕](#示例2自定义多边形路径环绕)

[ 惊鸿一瞥 -- CSS属性 -- shape-outside - 掘金 在本文中，将聚焦于这样一种CSS属性：\`shape-outside\`。这一属性或许并非家喻户晓，却能提供一种新颖的方法来控制文本环绕非矩形物体的流动，从而在视觉布局上实现更令人惊艳的设计。 https://juejin.cn/post/7313102241605713935](https://juejin.cn/post/7313102241605713935 " 惊鸿一瞥 -- CSS属性 -- shape-outside - 掘金 在本文中，将聚焦于这样一种CSS属性：`shape-outside`。这一属性或许并非家喻户晓，却能提供一种新颖的方法来控制文本环绕非矩形物体的流动，从而在视觉布局上实现更令人惊艳的设计。 https://juejin.cn/post/7313102241605713935")
