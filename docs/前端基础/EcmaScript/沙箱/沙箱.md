...
[qiankun的js沙箱原理及其实现](qiankun的js沙箱原理及其实现.md "qiankun的js沙箱原理及其实现")

[基于 iframe 的沙箱环境实现\_副本](<基于 iframe 的沙箱环境实现_副本.md> "基于 iframe 的沙箱环境实现_副本")

[基于 Proxy 的沙箱环境实现\_副本](<基于 Proxy 的沙箱环境实现_副本.md> "基于 Proxy 的沙箱环境实现_副本")

[仍在提案中的 SES\_副本](<仍在提案中的 SES_副本.md> "仍在提案中的 SES_副本")

[Web Workers 实现沙箱](<Web Workers 实现沙箱.md> "Web Workers 实现沙箱")
