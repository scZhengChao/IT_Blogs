...
![](./assets/image/image_Za4aHZgfCO.png)
...
![](./assets/image/image_xhVIbhMl-T.png)

2、确保在分支上以后，可以开始工作 （查看分支显示及分支切换，带有origin是远程分支，选择远程分支会显示对应的本地分支）：

![](./assets/image/image_f6qRIqhfZQ.png)

#### 开始使用

##### 加入暂存区，和取消修改操作

![](./assets/image/image_dNRsf_KDK0.png)
...
![](./assets/image/image_F0fVMdo1IU.png)

##### 取消暂存区，取消add操作

![](./assets/image/image_eHm_Y_oxLQ.png)

- 上图 “—” 取消所有暂存
- 同理，移到文件上，“—” 取消单个文件暂存
- 取消文件中部分修改

![](./assets/image/image_8Jtc_qrjVX.png)
...
![](./assets/image/image_lagSrmLMEh.png)

- 一步，消息栏输入提交信息，点击提交 （到本地仓库）
- 执行第二步，同步，会提醒先pull，有冲突需要先处理，没有自动push

![](./assets/image/image_0JFR5Gh-yn.png)
...
![](./assets/image/image_AK7CatD7aB.png)

点击其中一条提交记录

![](./assets/image/image_iQD4SID1ey.png)
...
![](./assets/image/image_YqKEvLGyuV.png)

同时提交信息出也有提示，↓ 表示有其他人提交，可以pull，↑ 表示可提交数

![](./assets/image/image_pOgvHcl--U.png)

##### 分支合并

![](./assets/image/image_bcbEhQFBCM.png)

选择要合并到当前分支的其他分支

![](./assets/image/image_J7U4MJVQvT.png)

也可以提交合并请求，由其他人处理，一般很少这样做

![](./assets/image/image_fW2yJ3zCBR.png)

##### 分支创建

###### 创建本地分支

![](./assets/image/image_LPfm-B3dO5.png)
...
![](./assets/image/image_j0OC7dM1ay.png)
...
![](./assets/image/image_kIIqmK2Efg.png)

##### 所有分支记录

源代码管理，分支图标

![](./assets/image/image_H1EQQA-9HF.png)

进行变基操作（将分支提交记录整理为线性）

![](./assets/image/image_s-gS2RV_7-.png)
...
![](./assets/image/image_DgL_vbfV0_.png)

**`恢复`**
“…” — 存储 — 应用存储（或者最新存储）

![](./assets/image/image_9fTVDcnZBZ.png)

如：应用存储，选择对应之前的存储信息，取出恢复

![](./assets/image/image_-_hTLElW1s.png)
