...
![](./assets/image/image_vNbq6PfQ-X.png)

文件被引用的路径为：`./patchers`（我们要拦截的路径）

![](./assets/image/image_eOOdPKLY8T.png)

文件内容为：

![](./assets/image/image_cJ2nhxQtWf.png)

复制内容到`src/assets/patchers.js`，修改其 `import` 路径为绝对路径，并添加我们的代码：

![](./assets/image/image_xG4NyzL0w9.png)
...
![](./assets/image/image_QS9bpZ4GVh.png)
...
![  ](./assets/image/dd50db5c981e9f9f8091867da49547ee_BC4q7hhmsW.png "  ")
