...
[mxEvent.LABEL\_CHANGED](mxEvent.LABEL_CHANGED.md "mxEvent.LABEL_CHANGED")

[mxEvent.CONNECT\_CELL](mxEvent.CONNECT_CELL.md "mxEvent.CONNECT_CELL")

[mxEvent.CELLS\_ADDED](mxEvent.CELLS_ADDED.md "mxEvent.CELLS_ADDED")

[mxEvent.MOVE\_CELLS](mxEvent.MOVE_CELLS.md "mxEvent.MOVE_CELLS")

[isPopupTrigger](isPopupTrigger.md "isPopupTrigger")

[redirectMouseEvents](redirectMouseEvents.md "redirectMouseEvents")

[isAltDown](isAltDown.md "isAltDown")

[mxEvent.CHANGE](mxEvent.CHANGE.md "mxEvent.CHANGE")

[事件](IT/前端专题/可视化/流程图process插件/mxGraph/事件/mxEvent/事件/事件.md "事件")

[FIRE\_MOUSE\_EVENT](FIRE_MOUSE_EVENT.md "FIRE_MOUSE_EVENT")
