...
- [二](#二)
  - [精读](#精读)
    - [动态规划与暴力、回溯算法的区别](#动态规划与暴力回溯算法的区别)
    - [存在最优子结构](#存在最优子结构)
    - [存在重复子问题](#存在重复子问题)
    - [无后效性](#无后效性)
    - [解法套路 - 状态转移方程](#解法套路---状态转移方程)
    - [爬楼梯问题](#爬楼梯问题)
    - [最大子序和](#最大子序和)
    - [最长递增子序列](#最长递增子序列)
    - [最长有效括号](#最长有效括号)
...
[ 「算法与数据结构」一张脑图带你看动态规划算法之美 - 掘金 算法中有个专题，动态规划，它十分的重要，大厂面试中或多或少有所涉及，来网易之前，刷了部分dp，这次正好再次梳理一遍，希望对你们有一点点帮助。 如果你已经懂了dp思路，或者已经掌握了常见的dp解法，可以直接跳过。 如果你还不了解，或者知道动态规划，但是还没有开始刷题的话，可能这篇… https://juejin.cn/post/6872115031501340679?searchId=20230720175726B147F8ED2F8BC220DBCF](https://juejin.cn/post/6872115031501340679?searchId=20230720175726B147F8ED2F8BC220DBCF " 「算法与数据结构」一张脑图带你看动态规划算法之美 - 掘金 算法中有个专题，动态规划，它十分的重要，大厂面试中或多或少有所涉及，来网易之前，刷了部分dp，这次正好再次梳理一遍，希望对你们有一点点帮助。 如果你已经懂了dp思路，或者已经掌握了常见的dp解法，可以直接跳过。 如果你还不了解，或者知道动态规划，但是还没有开始刷题的话，可能这篇… https://juejin.cn/post/6872115031501340679?searchId=20230720175726B147F8ED2F8BC220DBCF")

## 什么是动态规划

动态规划（Dynamic Programming），因此常用 DP 指代动态规划。动态规划，首先我们得清楚，它的概念是啥，它能解决什么问题，维基百科对它的解释👇

> 动态规划在寻找**有很多重叠子问题的情况的最佳解时有效**。它将问题重新组合成子问题，为了避免多次解决这些子问题，它们的结果都逐渐被计算并被储存，从简单的问题直到整个问题都被解决。因此，动态规划储存递归时的结果，因而不会在解决同样的问题时花费时间。
>
> 动态规划**只能应用于有最佳子结构的问题**。**最佳子结构的意思是局部最佳解能决定全域最佳解**（对有些问题这个要求并不能完全满足，故有时需要引入一定的近似）。简单地说，问题能够分解成子问题来解决。

我稍微总结一下👇

- 将一个大**的问题拆分成一个个子问题**，我们把它称之为子结构。
...
- 我们需要**借助数组**来保存之前计算的结果，所以一般采用的就是**数组来维护我们的结果**，一般dp数组。
- `dp`数组的**含义一定要明确**，也就是说，**dp\[i]** 表达是啥意思，举个例子，dp\[i]表达到达第i个阶梯时的方案数。

#### **列出状态转移方程**

- 通俗易懂的话，找出**数组间关系式**，这个时解决动态规范问题中，**最难也是最重要的一步。**
- 通常情况而言，`dp[i]`个状态的转移方程，跟`dp[i-1]` 与 `dp[i-2]` 之间**存在某种联系。**
...
[dd大牛的《背包九讲》](https://link.juejin.cn/?target=https://zhuanlan.zhihu.com/p/139368825 "dd大牛的《背包九讲》") 👈，可以看看这篇，这里就不展开了。

这里推荐几道题👇

- [分割等和子集- 01背包](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/partition-equal-subset-sum/ "分割等和子集- 01背包")
- [目标和 - 01背包-求方案数](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/target-sum/ "目标和 - 01背包-求方案数")
- [零钱兑换 - 完全背包](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/coin-change/ "零钱兑换 - 完全背包")
- [零钱兑换- II (完全背包-求方案数)](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/coin-change-2/ "零钱兑换- II (完全背包-求方案数)")
- [一和零 - (二维费用背包)](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/ones-and-zeroes/ "一和零 - (二维费用背包)")
...
- [最长上升子序列](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/longest-increasing-subsequence/ "最长上升子序列")
- [三角形最小路径和](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/triangle/ "三角形最小路径和")
- [最长公共子序列](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/longest-common-subsequence/ "最长公共子序列")
- [最大子序和](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/maximum-subarray/ "最大子序和")
- [俄罗斯套娃信封问题](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/russian-doll-envelopes/ "俄罗斯套娃信封问题")
...
- [最长回文子序列](https://link.juejin.cn?target=https://leetcode-cn.com/problems/longest-palindromic-subsequence/ "最长回文子序列")
- [统计不同回文子序列](https://link.juejin.cn?target=https://leetcode-cn.com/problems/count-different-palindromic-subsequences/ "统计不同回文子序列")
- [多边形三角剖分的最低得分](https://link.juejin.cn?target=https://leetcode-cn.com/problems/minimum-score-triangulation-of-polygon/ "多边形三角剖分的最低得分")
- [戳气球](https://link.juejin.cn?target=https://leetcode-cn.com/problems/burst-balloons/ "戳气球")
- [奇怪的打印机](https://link.juejin.cn?target=https://leetcode-cn.com/problems/strange-printer/ "奇怪的打印机")
...
- [打家劫舍 III](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/house-robber-iii/ "打家劫舍 III")
- [**时态同步**](https://link.juejin.cn/?target=https://www.luogu.org/problemnew/show/P1131 "时态同步")
- [**选课**](https://link.juejin.cn/?target=https://www.luogu.org/problemnew/show/P2014 "选课")
- [二叉树中的最大路径和](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/binary-tree-maximum-path-sum/ "二叉树中的最大路径和")
- [二叉树的直径](https://link.juejin.cn/?target=https://leetcode-cn.com/problems/diameter-of-binary-tree/ "二叉树的直径")
- [**战略游戏**](https://link.juejin.cn/?target=https://www.luogu.org/problemnew/show/P2016 "战略游戏")
...
- [数字 1 的个数](https://link.juejin.cn?target=https://leetcode-cn.com/problems/number-of-digit-one/ "数字 1 的个数")
- [最大为 N 的数字组合](https://link.juejin.cn?target=https://leetcode-cn.com/problems/numbers-at-most-n-given-digit-set/ "最大为 N 的数字组合")
- [可被 K 整除的最小整数](https://link.juejin.cn?target=https://leetcode-cn.com/problems/smallest-integer-divisible-by-k/ "可被 K 整除的最小整数")
...
- [打家劫舍](https://link.juejin.cn?target=https://leetcode-cn.com/problems/house-robber/ "打家劫舍")
- [使用最小花费爬楼梯](https://link.juejin.cn?target=https://leetcode-cn.com/problems/min-cost-climbing-stairs/ "使用最小花费爬楼梯")
- [连续数列](https://link.juejin.cn?target=https://leetcode-cn.com/problems/contiguous-sequence-lcci/ "连续数列")
- [三步问题](https://link.juejin.cn?target=https://leetcode-cn.com/problems/three-steps-problem-lcci/ "三步问题")

***

#### 中等

- [打家劫舍 II](https://link.juejin.cn?target=https://leetcode-cn.com/problems/house-robber-ii/ "打家劫舍 II")
- [最佳买卖股票时机含冷冻期](https://link.juejin.cn?target=https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/ "最佳买卖股票时机含冷冻期")
- [打家劫舍 III](https://link.juejin.cn?target=https://leetcode-cn.com/problems/house-robber-iii/ "打家劫舍 III")
- [不同路径](https://link.juejin.cn?target=https://leetcode-cn.com/problems/unique-paths/ "不同路径")
- [不同路径 II](https://link.juejin.cn?target=https://leetcode-cn.com/problems/unique-paths-ii/ "不同路径 II")
- [最长上升子序列](https://link.juejin.cn?target=https://leetcode-cn.com/problems/longest-increasing-subsequence/ "最长上升子序列")
...
- [买卖股票的最佳时机 III](https://link.juejin.cn?target=https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-iii/ "买卖股票的最佳时机 III")
- [买卖股票的最佳时机 IV](https://link.juejin.cn?target=https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-iv/ "买卖股票的最佳时机 IV")
- [青蛙过河](https://link.juejin.cn?target=https://leetcode-cn.com/problems/frog-jump/ "青蛙过河")

## 参考

- [告别动态规划，连刷 40 道题，我总结了这些套路](https://link.juejin.cn/?target=https://zhuanlan.zhihu.com/p/91582909 "告别动态规划，连刷 40 道题，我总结了这些套路")
- [如何理解动态规划？](https://link.juejin.cn/?target=https://www.zhihu.com/question/39948290 "如何理解动态规划？")
- [动态规划之背包问题系列](https://link.juejin.cn/?target=https://zhuanlan.zhihu.com/p/93857890 "动态规划之背包问题系列")
- [dd大牛的《背包九讲》](https://link.juejin.cn/?target=https://zhuanlan.zhihu.com/p/139368825 "dd大牛的《背包九讲》")
- [\[力扣\] DP问题分类汇总](https://link.juejin.cn/?target=https://zhuanlan.zhihu.com/p/126546914 "\[力扣] DP问题分类汇总")

# 二

[ 精读《算法 - 动态规划》 - 掘金 很多人觉得动态规划很难，甚至认为面试出动态规划题目是在为难候选人。动态规划不是魔法，它也是通过暴力方法尝试答案，只是方式更加 “聪明”，使得实际上时间复杂度并不高。 https://juejin.cn/post/6970860903092715550?searchId=20230720175726B147F8ED2F8BC220DBCF](https://juejin.cn/post/6970860903092715550?searchId=20230720175726B147F8ED2F8BC220DBCF " 精读《算法 - 动态规划》 - 掘金 很多人觉得动态规划很难，甚至认为面试出动态规划题目是在为难候选人。动态规划不是魔法，它也是通过暴力方法尝试答案，只是方式更加 “聪明”，使得实际上时间复杂度并不高。 https://juejin.cn/post/6970860903092715550?searchId=20230720175726B147F8ED2F8BC220DBCF")
...
动态规划不是魔法，它也是通过**暴力方法尝试答案**，只是方式更加 “聪明”，使得实际上**时间复杂度并不高**。
...
而动态规划也有**分支概念**，但**不用把每条分支尝试到终点**，而是在走到分叉路口时，可以直接根据前面各分支的表现，直接推导出下一步的最优解！然而无论是直接推导，还是前面各分支判断，都是有条件的。动态规划可解问题需同时满足以下三个特点：
...
&#x20;   什么是子问题？比如寻路算法中，**走完前几步就是相对于走完全程的子问题**，**必须保证走完全程的最短路径**可以**通过走完前几步推导出来，才可以用动态规划。**

不要小看这第一条，动态规划就难在这里，你到底如何**将最优子结构与全局最优解建立上关系？**
...
这个是动态规划与暴力解法的关键区别，动态规划之所以性能高，是因为 **不会对重复子问题进行重复计算**，算法上一般通过缓存计算结果或者自底向上迭代的方式解决，但**核心是这个场景要存在重复子问题**。
...
解决动态规划问题的核心就是**写出状态转移方程**，所谓状态转移，即通过某些之前步骤推导出未来步骤。
...
其实之前的 [精读《DOM diff 最长上升子序列》](https://link.juejin.cn?target=https://github.com/ascoders/weekly/blob/master/%E5%89%8D%E6%B2%BF%E6%8A%80%E6%9C%AF/192.%E7%B2%BE%E8%AF%BB%E3%80%8ADOM%20diff%20%E6%9C%80%E9%95%BF%E4%B8%8A%E5%8D%87%E5%AD%90%E5%BA%8F%E5%88%97%E3%80%8B.md "精读《DOM diff 最长上升子序列》") 有详细解析过这道题，包括还有更优的贪心解法，不过我们这次还是聚焦在动态规划方法上。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6264b4e668504e95bdc03767fd9d66e9~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

可以看到，`dp(i-1)` 就是第二条横线的长度，然后如果红色括号匹配的话，长度又 +2，最后别忘了最左边如果有满足匹配的也要带上，这就是 `dp(i - dp(i-1) - 2)`，所以加到一起就是这种场景的括号最大长度。

到这里，一维动态规划问题深度基本上探索完了，在进入多维动态规划问题前，还有一类一维动态规划问题，属于表达式不难，也没有这题这么复杂的嵌套 DP，但是思维复杂度极高，**你一定不要盯着全流程看，那样复杂度太高，你需要****充分认可 dp(i-x) 已经算出来部分的含义****，****进行高度抽象的思考****。**
...
首先看下递归终止条件。由于最多连续两个颜色相同，因此 `dp(0)` 与 `dp(1)` 分别是 `k` 与 `k*k`，因为每个栅栏随便刷颜色，自由组合。那么 `dp(2)` 有三个栅栏，非法情况是三个栅栏全同色，所以用**所有可能减掉非法即可，非法场景只有 ****`k`**** 中，所以结果是 ****`k*k*k - k`****。**
...
所以**最后总方案数就是两者之和**，即 `dp(i) = dp(i-2) * (k-1) + dp(i-1) * (k-1)`。
...
[爬楼梯](./爬楼梯/index.md "爬楼梯")

[打家劫🐍⭐⭐](./打家劫🐍⭐⭐/index.md "打家劫🐍⭐⭐")

[买卖股票的最佳时机 IV⭐⭐⭐](<./买卖股票的最佳时机 IV⭐⭐⭐/index.md> "买卖股票的最佳时机 IV⭐⭐⭐")

[斐波那契数](./斐波那契数/index.md "斐波那契数")

[](./第 N 个泰波那契数-/index.md)

[最长回文字符串](./最长回文字符串/index.md "最长回文字符串")

[最长公共子序列](./最长公共子序列/index.md "最长公共子序列")

## 子目录与文章

- [第 N 个泰波那契数-](./第%20N%20个泰波那契数-/index.md)
