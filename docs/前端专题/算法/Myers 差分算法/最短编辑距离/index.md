...
![](./image/image_Vpt-2SYPe-.png)

## 2. DP 的概念

在此之前，防止有些人不了解 DP，我先说一些基础概念。

![](./image/image_cN_suc_UwT.png)
...
![](./image/image_VkdWn963vj.png)

再看下一个位置。

![](./image/image_NQFD2MpypQ.png)
...
![](./image/image_NIkFYWvhfm.png)

其他格子也是同样的推理，我就不赘述了，结果如下图。

![](./image/image__CdlwB82Tg.png)
