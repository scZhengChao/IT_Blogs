...
- [查看版本](#查看版本)
- [1. 开始一个新工程](#1-开始一个新工程)
  - [跳过会话，直接通过默认值生成 package.json](#跳过会话直接通过默认值生成-packagejson)
- [2. 添加一个依赖](#2-添加一个依赖)
  - [1).生产环境](#1生产环境)
  - [2).开发环境](#2开发环境)
  - [3).全局](#3全局)
- [3. 更新一个依赖](#3-更新一个依赖)
- [4. 移除一个依赖](#4-移除一个依赖)
- [5. 安装 package.json 中的所有文件](#5-安装-packagejson-中的所有文件)
- [6. 运行脚本](#6-运行脚本)
- [7. 显示某个包信息](#7-显示某个包信息)
- [8. 列出项目的所有依赖](#8-列出项目的所有依赖)
- [9.管理 yarn 配置文件](#9管理-yarn-配置文件)
- [10. 缓存](#10-缓存)
- [11.代理](#11代理)
...
yarn add webpack@2.3.3 
 # yarn --save 是 yarn 默认的，默认记录在 package.json 中
npm install webpack@2.3.3 --save  
# npm
```
...
依赖会记录在 package.json 的 devDependencies 下 生产环境
...
npm config list
 ...
 yarn config set registry [https://registry.npm.taobao.org](https://registry.npm.taobao.org) # 设置淘宝镜像 
npm config set registry [https://registry.npm.taobao.org](https://registry.npm.taobao.org) # npm
```
...
yarn config set registry https://registry.yarnpkg.com 。 // 设置默认源
2、移除原代理
