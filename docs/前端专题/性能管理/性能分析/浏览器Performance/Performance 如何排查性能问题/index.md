...
![](./assets/image/image_-7cG5eEL7H.png)
...
![](./assets/image/image_oC8j3wdGig.png)
...
![](./assets/image/image_gQYJvRceb5.png)
...
![](./assets/image/image_HuebIW7quH.png)

我们可以看到，在性能面板中主线程在最后调用**了栅格线程做实际的渲染**

![](./assets/image/image_9ZcB-yRfpy.png)
...
![](./assets/image/image_ZkTYK5kDy6.png)
...
![](./assets/image/image_3JGj3n9QB8.png)
...
![](./assets/image/image_DWAyRN3ldB.png)
...
![](./assets/image/image_1Uo2qLyiac.png)

![](./assets/image/image_sD1EOCeBq3.png)

### lifecycle 和 paint timing

下图展示的是文章中提及的页面生命周期流程图。本节我们结合 Performance，对照该图进行观察。

![](./assets/image/image_H21yRtle0e.png)
...
![](./assets/image/image_7tNCqJY50D.png)
...
![](./assets/image/image_IHzbX1PYTT.png)
...
![](./assets/image/image_sD17TPAxrC.png)
...
![](./assets/image/image_bFT6UYAWav.png)
