...
![](./image/image_HuebIW7quH.png)

我们可以看到，在性能面板中主线程在最后调用**了栅格线程做实际的渲染**

![](./image/image_9ZcB-yRfpy.png)
...
![](./image/image_1Uo2qLyiac.png)

![](./image/image_sD1EOCeBq3.png)

### lifecycle 和 paint timing

下图展示的是文章中提及的页面生命周期流程图。本节我们结合 Performance，对照该图进行观察。

![](./image/image_H21yRtle0e.png)
