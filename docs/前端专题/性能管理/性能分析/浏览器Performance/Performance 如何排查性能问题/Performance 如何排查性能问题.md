...
![](image_HuebIW7quH.png)

我们可以看到，在性能面板中主线程在最后调用**了栅格线程做实际的渲染**

![](image_9ZcB-yRfpy.png)
