...
![](./image/image_XFQgRq3pWr.png)

上图是STUN协议的发送和接收流程

接下来我们来看看他的请求内容是什么

![](./image/image_vk_SN6nsQH.png)
...
![](./image/image_9T-v7kgyZw.png)

握手过程如下图：

![](./image/image_nPqZPTGlsS.png)
