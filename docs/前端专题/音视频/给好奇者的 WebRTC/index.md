...
[   https://webrtcforthecurious.com/zh/docs/02-signaling/#setup](https://webrtcforthecurious.com/zh/docs/02-signaling/#setup "   https://webrtcforthecurious.com/zh/docs/02-signaling/#setup")
...
本书可在[GitHub](https://github.com/webrtc-for-the-curious/webrtc-for-the-curious "GitHub")和[WebRTCforTheCurious.com](https://webrtcforthecurious.com/ "WebRTCforTheCurious.com")访问。我们许可您可以用您认为最好的方式使用本书。您也可以使用[ePub 格式](https://webrtcforthecurious.com/docs/webrtc-for-the-curious.epub "ePub 格式")或[PDF 格式](https://webrtcforthecurious.com/docs/webrtc-for-the-curious.pdf "PDF 格式")下载本书的当前版本。
...
我们需要您的帮助！本书完全在[GitHub](https://github.com/webrtc-for-the-curious/webrtc-for-the-curious "GitHub")上开发，并且仍在编写中。如果您对哪些部分有疑问，认为本书没有较好的覆盖到这些部分，我们鼓励您提出 issues。

## License（许可）&#x20;

本书可通过 CC0 许可获得。在法律允许的最大范围内，作者放弃了其作品中的所有版权和相关权。您可以根据需要使用此作品，并且无需注明出处。

[是什么，为什么，如何使用](./是什么，为什么，如何使用/index.md "是什么，为什么，如何使用")

[信令](./信令/index.md "信令")

[连接](./连接/index.md "连接")

[安全性](./安全性/index.md "安全性")
