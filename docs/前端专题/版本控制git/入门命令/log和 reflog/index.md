...
![](./assets/image/image_A0dD7tJfPk.webp)

rebase 的 合并操作

![](./assets/image/image_kSyMEdqsDg.webp)
...
![](./assets/image/image_AG5vK7hh3k.webp)

分支记录如上，想要 reset 到 b。

![](./assets/image/image_y7FRRaZSbu.webp)

误操作 reset 过头，b 没了，最新的只剩下 a。

![](./assets/image/image_0HPMKV3AOu.webp)
