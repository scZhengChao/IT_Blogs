...
![](./image/image_hATZDGfglS.png)

因为 revert 会生成一条新的提交记录，这时会让你**编辑提交信息，编辑完后 :wq 保存退出就好了。**

![](./image/image_9JJNkM-Rgx.png)
...
![](./image/image_5m5TDZ-n0y.png)

现在的 master 分支里多了条合并提交。

![](./image/image_jsm3Rfm9R0.png)
...
![](./image/image_OX9Fnv_T_m.png)

现在 master 的记录是这样的。

![](./image/image_6tWO29XUo-.png)
