...
![](./assets/image/image_PsU8s6Q61R.webp)

需要把 b 复制到另一个分支，首先把 commitHash 复制下来，然后切到 master 分支。

![](./assets/image/image_APfKnyprNc.webp)

当前 master 最新的记录是 a，使用 `cherry-pick` 把 b 应用到当前分支。

![](./assets/image/image_Yeg-1GKuJB.webp)
