...
[3.1. 整型](<./3.1. 整型/index.md> "3.1. 整型")

[3.2. 浮点数](<./3.2. 浮点数/index.md> "3.2. 浮点数")

[3.3. 复数](<./3.3. 复数/index.md> "3.3. 复数")

[3.4. 布尔型](<./3.4. 布尔型/index.md> "3.4. 布尔型")

[3.5. 字符串](<./3.5. 字符串/index.md> "3.5. 字符串")

[3.6. 常量](<./3.6. 常量/index.md> "3.6. 常量")
