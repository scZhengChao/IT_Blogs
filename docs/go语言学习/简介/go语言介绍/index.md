...
- [1.1.1. Go语言为并发而生](#111-Go语言为并发而生)
- [1.1.2. Go语言简单易学](#112-Go语言简单易学)
  - [语法简洁](#语法简洁)
  - [代码风格统一](#代码风格统一)
  - [开发效率高](#开发效率高)
- [1.1.3. 使用go的公司](#113-使用go的公司)
- [1.1.4. go适合做什么](#114-go适合做什么)
- [1.1.5. 学习Go语言的前景](#115-学习Go语言的前景)
...
- Google
  - [https://github.com/kubernetes/kubernetes](https://github.com/kubernetes/kubernetes "https://github.com/kubernetes/kubernetes")
- Facebook
  - [https://github.com/facebookgo](https://github.com/facebookgo "https://github.com/facebookgo")
- 腾讯
- 百度
- 360开源日志系统
  - [https://github.com/Qihoo360/poseidon](https://github.com/Qihoo360/poseidon "https://github.com/Qihoo360/poseidon")
