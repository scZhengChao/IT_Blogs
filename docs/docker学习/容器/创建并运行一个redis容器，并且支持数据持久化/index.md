...
![](./image/image_9Y8PXYnPkh.png)

##### 步骤二：查看Redis镜像文档中的帮助信息

![](./image/image_i_uualACXX.png)
...
![](./image/image_jL3iGlZIrr.png)

##### 步骤七:在window系统中使用redis客户端连接

![](./image/image_Nk0wlvmfVn.png)
