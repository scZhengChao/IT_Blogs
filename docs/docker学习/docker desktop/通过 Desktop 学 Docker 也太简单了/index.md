...
![](./assets/image/image_KF5hkDX0o7.webp)
...
![](./assets/image/image_w6IdZDPGHd.webp)
...
![](./assets/image/image_99F4yiVu8S.webp)

如果不可用，那要设置下这个：

![](./assets/image/image_bBmPzyAaDM.webp)
...
![](./assets/image/image_lDfchsspdd.webp)

![](./assets/image/image_f95VUB9t4x.webp)
...
![](./assets/image/image_0Vc5FG2rp5.webp)

搜索 nginx 镜像，点击 pull（搜索这步需要科学上网，不然搜不到）。

pull 下来之后，就可以在本地 images 看到了：

![](./assets/image/image_7XIFPp9lmY.webp)
...
![](./assets/image/image_H3f-oc-E5E.webp)
...
![](./assets/image/image_T4yAghoV6x.webp)
...
![](./assets/image/image_R_NnnwFJPo.webp)
...
![](./assets/image/image_4XpixIote0.webp)
...
![](./assets/image/image_H_08xGOR2F.webp)
...
![](./assets/image/image_5hF2tEkC5v.webp)
...
![](./assets/image/image_x6mxaFrkw8.webp)
