...
![](./assets/image/image_EkuL_lPkwH.webp)

`ls -a` 命令会列举出文件夹/目录中所有的文件，**包括隐藏文件：**

![](./assets/image/image_Q12DluBTKn.webp)

我们还可以将两个参数放在一起使用，输出的结果将是两个参数分别执行时的效果和：

![](./assets/image/image_pfVFeaaTkV.webp)
