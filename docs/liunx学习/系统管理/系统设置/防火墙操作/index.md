...
前面我们已经验证了Tomcat服务已经正常启动，接下来我们就可以尝试访问一下。访问地址：[http://192.168.138.130:8080，我们发现是访问不到的。](:8080，我们发现是访问不到的。 "http://192.168.138.130:8080，我们发现是访问不到的。")

![](./image/image_ucjIMWUT9F.png)
...
![](./image/image_9jaKWo9ltB.png)

防火墙引发的问题

![](./image/image_LvbVq08lXm.png)
