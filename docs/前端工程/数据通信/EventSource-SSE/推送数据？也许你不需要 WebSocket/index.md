...
![](./assets/image/image_KngBDUbJPR.webp)
...
![](./assets/image/image_e84y_7exNJ.webp)
...
![](./assets/image/image_M5xlW0l56K.webp)

![](./assets/image/image_kPRcIysXyS.webp)
...
![](./assets/image/image_rrWS0EaS5P.webp)
...
![](./assets/image/image_65vOSCbA4O.webp)
...
![](./assets/image/image_KU7p77dUz5.webp)

然后把 react 项目 index.tsx 里这几行代码删掉，它会导致额外的渲染：

![](./assets/image/image_vLUeB40tH-.webp)

执行 npm run start

因为 3000 端口被占用了，它会跑在 3001：

![](./assets/image/image_nfPdQ0MfL_.webp)

浏览器访问下：

![](./assets/image/image_bPmdJkI5ea.webp)
...
![](./assets/image/image_deFJ6i4NST.webp)

然后在 EventStream 里可以看到每一次收到的消息：

![](./assets/image/image_eE6IHls7h8.webp)
...
![](./assets/image/image_mRv51HSiR3.webp)
...
![](./assets/image/image_s77oBZ1HK3.webp)
...
![](./assets/image/image_c0yqfpxpOQ.webp)
...
![](./assets/image/image_0I16YRHBNW.webp)
...
![](./assets/image/image_5XkKHR7JyM.webp)

测试下：

![](./assets/image/image_9IXjlao1Yn.webp)
...
![](./assets/image/image_wVjpOk4Zfs.webp)
...
![](./assets/image/image_2gb31dFJsp.webp)

![](./assets/image/image_R6ouTdw098.webp)
