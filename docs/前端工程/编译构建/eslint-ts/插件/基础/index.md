...
- [背景知识](#背景知识)
- [插件](#插件)
- [type-typeof-limit](#type-typeof-limit)
- [type-instanceof-limit](#type-instanceof-limit)
...
如果能有一个智能助手，实时提**示代码中的哪些部分可以使用工具库中的函数代替就好了。对于前端来说，这个助理就是 ESLint。**
...
下面先来介绍下背景知识，在我之前的文章《[破解面试题，在 JavaScript 中如何判断变量类型？](https://juejin.cn/post/7117420187564900366 "破解面试题，在 JavaScript 中如何判断变量类型？")》中，提到过使用 typeof 和 instanceof 来判断变量类型是存在很多坑的，不信你看下面的例子，如果你对这个问题感兴趣，欢迎阅读我上面的文章：

```javascript title="typeof []; // 'object'typeof {}; // 'object' typeof c; // 'object'[] instanceof Array // true[] instanceof Object // true 注意这里"
typeof []; // 'object'
...
Yeoman 是一**款通用的初始化工具**，想要初始化 ESLint 插件，需要安装 ESLint 模板，安装命令如下：
...
![](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/f3a2a751e1c844b9a76f8a7b63e4dc4c~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6aKc5rW36ZWc:q75.awebp?rk3s=f64ab15b\&x-expires=1725188306\&x-signature=xVvYNN24Q26Hy8pwP7ZV07c3B5I%3D)
...
![](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/3a8c2a7243a844f2a6334dbf02303ad7~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6aKc5rW36ZWc:q75.awebp?rk3s=f64ab15b\&x-expires=1725188306\&x-signature=5nGv%2BMUhXqgTkZhHP0gUk5A7QDs%3D)
...
![](./assets/image/image_IgsTz15Wk7.webp)
...
新建一个空项目 eslint-plugin-utils-demo，并初始化 ESLint 配置，接下来，在 eslint- plugin-utils-demo 根目录下执行下面的命令，这会在 node\_modules 目录下创建一个软链接。
...
![](https://p6-xtjj-sign.byteimg.com/tos-cn-i-73owjymdk6/ff57d8189d294f67917d720588d06625~tplv-73owjymdk6-jj-mark-v1:0:0:0:0:5o6Y6YeR5oqA5pyv56S-5Yy6IEAg6aKc5rW36ZWc:q75.awebp?rk3s=f64ab15b\&x-expires=1725188306\&x-signature=KhhZGz99kI28hwahVWJEU3P%2B9O4%3D)
