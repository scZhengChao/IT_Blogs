...
- [解决Vue版本更新问题](#解决Vue版本更新问题)
  - [1.禁止缓存](#1禁止缓存)
  - [2.页面检测跟新；手动刷新](#2页面检测跟新手动刷新)
    - [最终解决如下](#最终解决如下)

[   https://www.cnblogs.com/the-last/p/11636451.html](https://www.cnblogs.com/the-last/p/11636451.html "   https://www.cnblogs.com/the-last/p/11636451.html")

## **解决Vue版本更新问题**

### 1.禁止缓存

对html 文件 不使用缓存；或者协商缓存；禁止使用强缓存；应为html 一般不带hash值
...
        每次都加载项目入口文件 index.html。也就是说服务器端设置index.html文件不缓存、或者通过URL后缀添加随机字符串来解决。这个方案适合入口URL可变更的系统。但对于ERP这种内部系统来说，可行性不是很好。由于入口只加载一次，导致点击系统的其他导航栏URL操作，无法做到再次加载index.html文件，刷新浏览器缓存的JS。
...
这个也不行，并不会导致index.html被重新加载。具体原因，请详看源码解析：[vue-router源码分析-整体流程](https://github.com/DDFE/DDFE-blog/issues/9 "vue-router源码分析-整体流程")
...
官方是提供的，详看官方文档：[vue导航钩子](https://router.vuejs.org/zh-cn/advanced/navigation-guards.html "vue导航钩子")。
...
![  ](./assets/image/387466-20170807183424174-1863777749_wg1-egs-mK.webp "  ")

3.给编译环境添加env变量：

![  ](./assets/image/387466-20170807183519534-1036585674_diFH0RdTr3.webp "  ")
...
![  ](./assets/image/387466-20171201101913195-2066411951_wDlz65uR1o.webp "  ")

 6. ok，至此结束。 执行编译：

npm run build

![  ](./assets/image/387466-20170807184054096-112524305_QYROTyeEpr.webp "  ")

 7. 访问项目，再次编译版本，打开之前的项目界面，点击其他导航菜单，效果如下：

![  ](./assets/image/387466-20170807184524768-667532243_AEcRDP5jIG.webp "  ")
