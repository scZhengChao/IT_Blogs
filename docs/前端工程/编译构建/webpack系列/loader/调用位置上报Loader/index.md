# 手写 loader: 我要在方法调用的时候， 上报调用源文件地址

## 目录

- [步骤 1: 设计你的上报逻辑](#步骤-1-设计你的上报逻辑)
- [步骤 2: 创建自定义 Loader](#步骤-2-创建自定义-Loader)
- [步骤 3: 在 webpack 配置中使用你的 Loader](#步骤-3-在-webpack-配置中使用你的-Loader)
- [注意事项](#注意事项)
