...
![](./assets/image/image_3Va2zzoR6a.webp)
...
![](./assets/image/image_VwQ3B5ok5B.webp)
...
![](./assets/image/image_IXLS1Y_Ehg.webp)
...
![](./assets/image/image_B41tfZH84e.webp)
...
![](./assets/image/image_ohvEcKmUjP.webp)
...
![](./assets/image/image_8R8n0RsUX_.webp)
...
![](./assets/image/image_x_3G2RuH53.webp)

设置容器名为 gray1，端口映射宿主机的 82 到容器内的 80

![](./assets/image/image_1KNFJOoXGE.webp)
...
![](./assets/image/image_h_HxMwLpGb.webp)
...
![](./assets/image/image_gX5C9VcxKB.webp)
...
![](./assets/image/image_jq3Z016-4F.webp)

点开看看：

![](./assets/image/image_9PIHEzEu9x.webp)

这就是本地的那个文件。

我们在本地改一下试试：

![](./assets/image/image_82mhlTI4Ea.webp)

容器内也同样修改了。

![](./assets/image/image_XkouUKY1G2.webp)
...
![](./assets/image/image_dsdrFKR2mV.webp)

nest 服务访问成功了。

现在我们不**是直接访问 nest 服务了，而是经历了一层 nginx 反向代理或者说网关层。**

![](./assets/image/image_gjXymBd057.webp)

自然，我们可以在这一层实现流量控制的功能。

前面我们讲负载均衡的时候，是这么配的：

![](./assets/image/image_RzkXNWpcHi.webp)
...
![](./assets/image/image_7vn0FFAzYy.webp)

这样就实现了流量的划分，也就是灰度的功能。

然后我们重新跑下容器：

![](./assets/image/image_M48b-MAoUa.webp)
...
![](./assets/image/image_bubJA_mwwV.webp)
