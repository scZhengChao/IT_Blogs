...
![](image_x_3G2RuH53.png)

设置容器名为 gray1，端口映射宿主机的 82 到容器内的 80

![](image_1KNFJOoXGE.png)
...
![](image_jq3Z016-4F.png)

点开看看：

![](image_9PIHEzEu9x.png)

这就是本地的那个文件。

我们在本地改一下试试：

![](image_82mhlTI4Ea.png)

容器内也同样修改了。

![](image_XkouUKY1G2.png)
...
![](image_7vn0FFAzYy.png)

这样就实现了流量的划分，也就是灰度的功能。

然后我们重新跑下容器：

![](image_M48b-MAoUa.png)
