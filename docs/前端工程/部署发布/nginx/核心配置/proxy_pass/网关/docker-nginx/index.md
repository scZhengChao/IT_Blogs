...
![](./assets/image/image_dKL6fdAJnH.webp)
...
![](./assets/image/image_5xwztcZMTY.webp)
...
![](./assets/image/image_AEk-oMR5V8.webp)
...
![](./assets/image/image_aqm3-kVUMc.webp)
...
![](./assets/image/image_HxxwnliMYA.webp)

在 nest 服务的 handler 里注入 headers，打印一下：

![](./assets/image/image_4hsyeUop-q.webp)

然后浏览器访问下。

直接访问 nest 服务的话，是没有这个 header 的：

![](./assets/image/image_LQ5is4TMsN.webp)

![](./assets/image/image_wJIUqPrFZo.webp)
...
![](./assets/image/image_K6EP1-catV.webp)

把 nest 服务停掉，然后重新 npm run start

![](./assets/image/image_G4WPJH0KAB.webp)

3001 和 3002 端口各跑一个：

![](./assets/image/image_d9yRutorby.webp)
...
![](./assets/image/image_pFEcbMVXDD.webp)
...
![](./assets/image/image_C3hOBy7LzK.webp)
...
![](./assets/image/image_XKyGGZtIDK.webp)
...
![](./assets/image/image_joFodW7yrd.webp)
...
![](./assets/image/image_B8-YUZwpuj.webp)
...
![](./assets/image/image_EMeFlOYGXS.webp)

这就是带权重的轮询。

我们再试下 ip\_hash 的方式；

![](./assets/image/image_nHMlxWWISS.webp)
...
![](./assets/image/image_HuVA-ILUKL.webp)

按 command + k，把 nest 服务的控制台日志清空下：

![](./assets/image/image_KhIUyNrmhO.webp)
