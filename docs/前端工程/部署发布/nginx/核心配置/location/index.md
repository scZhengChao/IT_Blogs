...
![](./assets/image/image_Js04BEV497.webp)

location 和路径**之间加了个 =，代表精准匹配，** 也就是只有完全相同的 url 才会匹配这个路由。

![](./assets/image/image_oGepRTusTm.webp)

![](./assets/image/image_51i4KxYoxh.webp)

# \*\*不带 = \*\*

**不带 = 代表根据前缀匹配，后面可以是任意路径。**

![](./assets/image/image_in8RGB4jyM.webp)

**这里的 \$uri 是取当前路径。**

![](./assets/image/image_qK39d5_emf.webp)

![](./assets/image/image_REejOhBEx8.webp)

# 正则

然后**如果想支持正则，就可以加个 \~。**

![](./assets/image/image_cMpH1MsHQw.webp)

这里的正则语法不难看懂，就是 /aaaa/bbb 开头，然后中间是任意字符，最后 .html 结尾的 url。

![](./assets/image/image_rN0QCdeXCl.webp)

![](./assets/image/image_JsW2ILYhas.webp)

**但是它是区分大小写的，比如这样就不行了：**

![](./assets/image/image_a5SVGbfjnc.webp)
...
![](./assets/image/image_y9rCR-wt9O.webp)
...
![](./assets/image/image_at01CUdHkm.webp)
