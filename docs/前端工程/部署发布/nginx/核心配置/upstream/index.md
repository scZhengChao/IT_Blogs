...
![](./assets/image/image_wCa6fMZan-.webp)
...
![](./assets/image/image_zJwHI-a5J8.webp)
...
![](./assets/image/image_t35kmM3XwF.webp)
...
![](./assets/image/image_uiuGASdPIL.webp)
...
![](./assets/image/image_SLVnKxEuOV.webp)

这就是带权重的轮询。

我们再试下 ip\_hash 的方式；

![](./assets/image/image_wPKhpBU6wb.webp)
...
![](./assets/image/image_oJsPB5ARlc.webp)

按 command + k，把 nest 服务的控制台日志清空下：

![](./assets/image/image_I7GDq-LNH5.webp)
