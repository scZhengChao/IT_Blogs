...
![](./image/image_SLVnKxEuOV.png)

这就是带权重的轮询。

我们再试下 ip\_hash 的方式；

![](./image/image_wPKhpBU6wb.png)
...
![](./image/image_oJsPB5ARlc.png)

按 command + k，把 nest 服务的控制台日志清空下：

![](./image/image_I7GDq-LNH5.png)
