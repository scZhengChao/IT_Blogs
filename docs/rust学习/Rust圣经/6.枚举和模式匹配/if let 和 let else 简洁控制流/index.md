...
- [使用 let...else 来保持在 “愉快路径”（“Happy Path”）](#使用letelse来保持在-愉快路径Happy-Path)
- [总结](#总结)
...
## [使用 ](https://kaisery.github.io/trpl-zh-cn/ch06-03-if-let.html#使用-letelse-来保持在-愉快路径happy-path "使用 ")[let...else](https://kaisery.github.io/trpl-zh-cn/ch06-03-if-let.html#使用-letelse-来保持在-愉快路径happy-path "let...else")[ 来保持在 “愉快路径”（“Happy Path”）](https://kaisery.github.io/trpl-zh-cn/ch06-03-if-let.html#使用-letelse-来保持在-愉快路径happy-path " 来保持在 “愉快路径”（“Happy Path”）")
...
如果你的程序遇到**一个使用 match 表达起来过于冗长的逻辑，记住 if let 和 let...else 也在你的 Rust 工具箱中。**

## [总结](https://kaisery.github.io/trpl-zh-cn/ch06-03-if-let.html#总结 "总结")
