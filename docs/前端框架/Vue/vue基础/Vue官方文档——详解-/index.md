...
![  ](./image/1935242305-5b03be0574ef1_big64_ZKOtIS6JoQ.jpeg "  ")

![  ](./image/rp_6q_I18AX3V.png "  ")
...
![  ](./image/bV9e4M_YMYAMrumXH.png "  ")

**2、data函数不能使用箭头函数**

![  ](./image/bV9e5M_9_wHPKrwx8.png "  ")

**3、watch中不能使用箭头函数**

![  ](./image/bV9e6A_ZUT5_HVy_0.png "  ")

**4、methods中不能使用箭头函数**

![  ](./image/bV9e6P_HDqtNExIIG.png "  ")

**5、computed不能使用箭头函数**

![  ](./image/bV9fuE_xZ8p5K4q18.png "  ")

#### 一、全局配置

Vue.config 是一个对象，包含 Vue 的全局配置，vue.config的配置全部在在main.js中设置的，如下：

![  ](./image/bV89Q6_YQ_nRIpRPK.jpeg "  ")

官网中给出的常用配置如下：

![  ](./image/bV89Pl_Fi3oH-23Lk.png "  ")
...
![  ](./image/bV9bqt_7j7c7dZ1I-.png "  ")

通过插件Vue performance可以看到每个组件的时间分配：

![  ](./image/bV9bq4_mWAv2fpoAW.png "  ")
...
![  ](./image/bV9la2_o07pp6-quP.png "  ")

**过滤器可以管道式链接过滤，管道符："|"**

![  ](./image/bV9lew_T_9Wntp8Uz.png "  ")

**8、Vue.component注册全局组件**

> 全局注册的组件可以在多个构造器中使用，但是局部注册的组件只能在组件注册的作用域里进行使用，其他作用域使用无效。

![  ](./image/bV9lpj_6qUYnp71HG.png "  ")
...
![  ](./image/bV9lsU_LGxJr99kew.png "  ")

**10、Vue.version获取安装的Vue版本号**

![  ](./image/bV9lwF_AqzhIvgyms.png "  ")
...
![  ](./image/bV9Fbe_OfSgQw_G49.png "  ")

得到的前端页面结构如下：

![  ](./image/bV9Fb9_bI7UXEdMs-.png "  ")
...
![  ](./image/bV9Fro_B1PWE2QyEz.png "  ")

（4）、两种组件写法

![  ](./image/bV9Fxq_QlZ0rrv5di.png "  ")

![  ](./image/creativecommons-cc_0_j4u2ldO8.png "  ")
...
![  ](./image/user-128_Ejru5G1wp9.png "  ")

![  ](./image/20190610_Z_9iGELyzA.png "  ")
