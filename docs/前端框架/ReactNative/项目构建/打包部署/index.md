...
![  ](./image/82bdce142bb3e43b7c525e1996c38c21_ZkSBof4Vz7.png "  ")

注意：输入密钥库口令【很重要，要记住】

生成的的keystore文件默认是在项目的根目录中,如下图所示:

![  ](./image/bbbd0aa01be945cc85aebccad434b713_uwAVlxkPCV.png "  ")
...
![  ](./image/38f39ba2418fa0621854507967e7de48_8ZCFDcIRtk.png "  ")
...
![  ](./image/8ca8763db1542eb400da1255acecd731_diZ83kI2oW.png "  ")

# 5修改应用icon

将如下文件夹中的icon替换成需要修改的图标即可,注意icon大小保持一致

![  ](./image/55e30c2471fdcd6eca1faf81bae742ef_ZwUJ8CFZKP.png "  ")
...
![  ](./image/44945a5518cd4f3fa4da17d58144b984__xZnrO2ed4.png "  ")
