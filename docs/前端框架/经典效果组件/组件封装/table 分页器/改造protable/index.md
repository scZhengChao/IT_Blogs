...
![](./assets/image/image_OkRWS0IUc_.webp)

![](./assets/image/image_8MJsJuQMCS.webp)
    ...
    >
      ...
      {submitter && (
        <Col
          ...
          style={{
            textAlign:needCollapseRender?'end':'start',
          }}
        >
          <Form.Item
            label=" "
...
![](./assets/image/image_XKAWc4Root.webp)

![](./assets/image/image_O9tdFj5K5v.webp)
...
import { ConfigProvider, Table ,Input,Space, Button,Row,Col} from 'antd';
            ...
            <Row gutter={16} style={{padding:24}}>
                <Col span={16}>
                    <Search
                        ...
                        enterButton="搜索"
                        onSearch={(value)=>{
                             const key = searchConfig.seniorIndex || 'keywords'
