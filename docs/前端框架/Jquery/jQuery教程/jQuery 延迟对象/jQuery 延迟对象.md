...
[jQuery.Deferred()](jQuery.Deferred().md "jQuery.Deferred()")

[deferred.always()](deferred.always().md "deferred.always()")

[deferred.done() ](deferred.done()-.md "deferred.done() ")

[deferred.fail()](deferred.fail().md "deferred.fail()")

[deferred.notify()](deferred.notify().md "deferred.notify()")

[deferred.notifyWith() ](deferred.notifyWith()-.md "deferred.notifyWith() ")

[deferred.pipe()](deferred.pipe().md "deferred.pipe()")

[deferred.progress()](deferred.progress().md "deferred.progress()")

[deferred.promise()](deferred.promise().md "deferred.promise()")

[deferred.reject() ](deferred.reject()-.md "deferred.reject() ")

[deferred.rejectWith()](deferred.rejectWith().md " deferred.rejectWith()")

[deferred.resolve()](deferred.resolve().md "deferred.resolve()")

[deferred.resolveWith()](deferred.resolveWith().md "deferred.resolveWith()")

[deferred.state()](deferred.state().md "deferred.state()")

[deferred.then()](deferred.then().md "deferred.then()")

[ .promise() 方法](<-promise() 方法.md> " .promise() 方法")
