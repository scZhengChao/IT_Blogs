...
- [文档](#文档)
  - [如何设计一个自定义Hooks](#如何设计一个自定义Hooks)
  - [通用模式](#通用模式)
  - [简单的小例子：usePow](#简单的小例子usePow)
- [玩转React Hooks](#玩转React-Hooks)
  - [useMemo](#useMemo)
  - [useCallback](#useCallback)
  - [useRef](#useRef)
    - [通过useRef获取对应的属性值](#通过useRef获取对应的属性值)
    - [缓存数据](#缓存数据)
    - [useLatest](#useLatest)
    - [结合useMemo和useRef封装useCreation](#结合useMemo和useRef封装useCreation)
    - [验证 useCreation](#验证-useCreation)
  - [useEffect](#useEffect)
    - [useMount](#useMount)
    - [useUnmount](#useUnmount)
    - [结合useMount和useUnmount做个小例子](#结合useMount和useUnmount做个小例子)
    - [useUpdate](#useUpdate)
- [案例](#案例)
  - [案例1: useReactive](#案例1-useReactive)
    - [分析](#分析)
    - [代码](#代码)
    - [验证](#验证)
  - [案例2: useEventListener](#案例2-useEventListener)
    - [代码](#代码)
    - [优化](#优化)
    - [详细代码](#详细代码)
    - [验证](#验证)
    - [小例子 useHover](#小例子-useHover)
  - [案例3: 有关时间的Hooks](#案例3-有关时间的Hooks)
...
[   https://ahooks.js.org/zh-CN/hooks/async](https://ahooks.js.org/zh-CN/hooks/async "   https://ahooks.js.org/zh-CN/hooks/async")
...
![](./assets/image/image_5Qd9YwfH9g.webp)
...
![](./assets/image/image_4VR2E1y-Ha.webp)
...
我们看出 `useMemo`只有在`list`发生变化的时候才会进行渲染，从而减少了不必要的开销
...
![](./assets/image/image_0FZuDuZThp.webp)
...
![](./assets/image/image_sYMPQ2V8N_.webp)
...
![](./assets/image/image_JcGYvVVyuQ.webp)
...
![](./assets/image/image_T_5WfTCHxK.webp)
...
![](./assets/image/image_570F1YKZ9r.webp)
...
![](./assets/image/image_-C_w1LrxOO.webp)
...
![](./assets/image/image_lgubmmM0vc.webp)
...
![](./assets/image/image_6fvym--huc.webp)
...
![](./assets/image/image_0XGwYQWO6i.webp)
...
[ahooks/utils](./ahooks-utils/index.md "ahooks/utils")
