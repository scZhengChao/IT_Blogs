...
项目名称暂定为Warp Exchange，采用[GPL v3](https://www.gnu.org/licenses/gpl-3.0.txt "GPL v3")授权协议。项目最终完成后，效果如下：

![](https://liaoxuefeng.com/books/java/springcloud/architecture/snapshot.png)
...
![](./assets/image/image_kco8Vyc3Ap.webp)
...
![](./assets/image/image_UUE27Q_FjC.webp)
