...
- [为什么不使用数据库？](#为什么不使用数据库)
- [为什么要使用ConcurrentMap？](#为什么要使用ConcurrentMap)
- [如何扩展以支持更多的资产类型？](#如何扩展以支持更多的资产类型)
- [参考源码](#参考源码)
- [小结](#小结)
...
可以从[GitHub](https://github.com/michaelliao/warpexchange/tree/main/step-by-step/step-2 "GitHub")或[Gitee](https://gitee.com/liaoxuefeng/warpexchange/tree/main/step-by-step/step-2/ "Gitee")下载源码。

[GitHub](https://github.com/michaelliao/warpexchange/tree/main/step-by-step/step-2 "GitHub")
