...
Spring是JavaEE的**一个轻量级开发框架，主营IoC和AOP，集成JDBC、ORM、MVC等功能**便于开发。
...
![](https://liaoxuefeng.com/books/java/springcloud/springcloud.png)
...
[项目架构设计](./项目架构设计/index.md "项目架构设计")

[搭建项目框架](./搭建项目框架/index.md "搭建项目框架")

[设计交易引擎](./设计交易引擎/index.md "设计交易引擎")
