...
![](./image/image_zZ_JMWvBC8.png)

> **注意：入参类型可以不写；会自动推导**

2.insert标签

![](./image/image_nZ6bOElsjM.png)
...
![](./image/image__4vcVnIttj.png)

![](./image/image_2aJbz9UqqP.png)
...
![](./image/image_V_4zJOI0QI.png)

![](./image/image_As6Lk7Krt0.png)

4.delete标签

![](./image/image_wKVGtbu7IQ.png)
...
![](./image/image_wwMYWdPGLO.png)

![](./image/image_-ruDrYnL2z.png)
