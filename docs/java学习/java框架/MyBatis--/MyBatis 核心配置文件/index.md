...
![](./image/image_n-ki0JMVaA.png)

可以通过设置一些短名来代替全限定名

方式：使用`typeAliases`标**签的子标签package包扫描映射别名(推荐)；**

![](./image/image_ofNBCCvJxW.png)
