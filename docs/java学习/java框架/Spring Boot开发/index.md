...
我们已经在前面详细介绍了Spring框架，它的主要功能包括**IoC容器、AOP支持、事务支持、MVC开发以及**强大的第三方集成功能等。

那么，Spring Boot又是什么？它和Spring是什么关系？

**Spring Boot是一个基于Spring的套件，它帮我们预组装了Spring的一系列组件，以便以尽可能少的代码和配置来**开发基于Spring的Java应用程序。
...
Spring Boot的目标就是**提供一个开箱即用的应用程序架构**，我们基于Spring Boot的**预置结构继续开发，省时省力。**
...
Spring Boot的官网入口是[这里](https://spring.io/projects/spring-boot "这里")，建议添加到浏览器收藏夹。

[第一个Spring Boot应用](<./第一个Spring Boot应用/index.md> "第一个Spring Boot应用")

[使用开发者工具](./使用开发者工具/index.md "使用开发者工具")

[打包Spring Boot应用](<./打包Spring Boot应用/index.md> "打包Spring Boot应用")

[使用Actuator](./使用Actuator/index.md "使用Actuator")

[使用Profiles](./使用Profiles/index.md "使用Profiles")

[使用Conditional](./使用Conditional/index.md "使用Conditional")

[加载配置文件](./加载配置文件/index.md "加载配置文件")

[禁用自动配置](./禁用自动配置/index.md "禁用自动配置")
