...
[Open API](https://www.openapis.org/ "Open API")是一个标准，它的主要作用是描述REST API，既可以作为文档给开发者阅读，又可以让机器根据这个文档自动生成客户端代码等。
...
![](https://liaoxuefeng.com/books/java/springboot/integration/open-api/open-api.png)
...
![](https://liaoxuefeng.com/books/java/springboot/integration/open-api/open-api-desc.png)

大多数情况下，不需要任何配置，我们就直接得到了一个运行时动态生成的可交互的API文档，该API文档总是和代码保持同步，大大简化了文档的编写工作。

要自定义文档的样式、控制某些API显示等，请参考[springdoc文档](https://springdoc.org/ "springdoc文档")。
