...
我们在Spring中已经学过了[集成Filter](https://liaoxuefeng.com/books/java/spring/web/filter/index.html "集成Filter")，本质上**就是通过代理，把Spring管理的Bean注册到Servlet容器中，** 不过步骤比较繁琐，需要配置`web.xml`。
