...
![](./assets/image/image_6zl7v5sVMq.webp)

上述这种通过一个“基础”组件再叠加各种“附加”功能组件的模式，**称之为Filter模式（或者装饰器模式：Decorator）**。它可以让我们通过少量的类来实现各种功能的组合：

![](./assets/image/image_8sysDlEwt-.webp)

类似的，`OutputStream`也是以这种模式来提供各种功能：

![](./assets/image/image_XnYfIgqATb.webp)
...
Filter**模式可以在运行期动态增加功能（又称Decorator模式）。**
