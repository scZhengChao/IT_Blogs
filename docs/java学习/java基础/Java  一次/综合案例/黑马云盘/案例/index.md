...
![](./image/image_xgIXaLyC-0.png)

### 2.2 客户端实现

![](./image/image_INUwecoCHx.png)
...
![](./image/image_JMLbbW8vOk.png)

加了头信息的数据如下：

![](./image/image_rOWS6plfhS.png)
...
![](./image/image_ApqxIUXoNK.png)

代码结构：

![](./image/image_rFc2MfcslZ.png)

基础代码请看看今天资料

#### 客户端架构

![](./image/image_iVHvqHkjJy.png)

项目结构：

![](./image/image_md0Zxh7uOQ.png)
