...
![](./image/image_Wd1w-IaKkP.png)

spring-boot-autoconfigure-2.3.4.RELEASE.jar包里面也有META-INF/spring.factories

![](./image/image_U_SZ7Iyatl.png)

**通过这个配置文件加载的自动配置：当前版本（2.3.10）是有127个默认的自动化配置**

![](./image/image_WHZGcjjWeE.png)
