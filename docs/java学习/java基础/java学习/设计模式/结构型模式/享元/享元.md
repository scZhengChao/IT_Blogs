...
在实际应用中，我们经常使用成熟的缓存库，例如[Guava](https://github.com/google/guava "Guava")的[Cache](https://github.com/google/guava/blob/master/guava/src/com/google/common/cache/Cache.java "Cache")，因为它提供了最大缓存数量限制、定时过期等实用功能。
