...
使用SLF4J和Logback和前面讲到的使用Commons Logging加Log4j是类似的，先分别下载[SLF4J](https://www.slf4j.org/download.html "SLF4J")和[Logback](https://logback.qos.ch/download.html "Logback")，然后把以下jar包放到classpath下：
