...
在代码**中获取原始异常**可以使用`Throwable.getCause()`方法。**如果返回**\*\*`null`，说明已经是“根异常”了。\*\*​
...
如果在执行`finally`语**句时抛出异常，那么，** \*\*`catch`\*\***语句的异常还能否继续抛出？例如**：
...
![](https://liaoxuefeng.com/books/java/exception/throw-exception/pa.png)
