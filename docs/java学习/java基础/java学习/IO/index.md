...
因此，`Reader`和`Writer`**本质上是一个能自动编解码**的`InputStream`和`OutputStream`。
...
- **二进制数据**以`byte`为最小单位在`InputStream`/`OutputStream`中单向流动；
- **字符数据**以`char`为最小单位在`Reader`/`Writer`中单向流动。
...
[File对象](IT/服务端/java学习/java基础/java学习/IO/File对象/File对象.md "File对象")

[InputStream](./InputStream/index.md "InputStream")

[OutputStream](./OutputStream/index.md "OutputStream")

[Filter模式(装饰器模式)](./Filter模式(装饰器模式)/index.md "Filter模式(装饰器模式)")

[操作Zip](./操作Zip/index.md "操作Zip")

[读取classpath资源](./读取classpath资源/index.md "读取classpath资源")

[序列化](IT/服务端/java学习/java基础/java学习/IO/序列化/序列化.md "序列化")

[Reader](./Reader/index.md "Reader")

[Writer](./Writer/index.md "Writer")

[PrintStream和PrintWriter](./PrintStream和PrintWriter/index.md "PrintStream和PrintWriter")

[使用Files](./使用Files/index.md "使用Files")

[读配置文件（工具）](./读配置文件（工具）/index.md "读配置文件（工具）")
