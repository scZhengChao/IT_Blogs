...
1. 导入Logback所需的相关jar文件，并添加到项目资源库中
   ...
   - lib目录下的存储的jar文件，添**加到当前项目资源库中**![](./assets/image/image_uYTraUsrUM.webp)
   然后ok 就可以了
...
![](./assets/image/image_V-EcT1gc3a.webp)

![](./assets/image/image_BjMVk3VFs4.webp)

# 总结

![](./assets/image/image_SUvvCLfvgd.webp)
