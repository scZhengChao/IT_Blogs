...
![](./image/image_aXD_ogS0fJ.png)

![](./image/image_76mzDGRAn2.png)

2\). 添加分类

在当前项目中,有针对用户、股票、日志、权限等相关的操作，我们在进行接口维护时，可以针对接口进行分类，如果没有对应的分类，我们自己添加分类；

![](./image/image_hfXz-meAoE.png)

3\). 添加接口

![](./image/image_xinFye5lX1.png)

接口基本信息录入之后，点击提交按钮，就可以看到该接口的基本信息：

![](./image/image_vMpfXNu1fZ.png)
...
![](./image/image_WZJq7pcuYr.png)

导入过程中出现的确认弹窗，选择"确认"。

![](./image/image_C0eujKTINH.png)

导入效果：

![](./image/image_e4soGwkQzz.png)
