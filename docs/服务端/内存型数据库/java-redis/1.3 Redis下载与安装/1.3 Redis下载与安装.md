...
![](image_nBI5TZkBRn.png)

**2.上传"redis"到Linux系统/soft目录下**

![](image_BOzq-7k-la.png)
...
![](image_uNFXFEyHNQ.png)

解压好之后会出现redis-4.0.0目录

![](image_FDihiuCC8z.png)

切换到redis-4.0.0目录下查看内容，下面内容是redis的源码。

![](image_LPmXGWRlO6.png)
...
![](image_Qc6ILNp34Y.png)

如下信息代表编译成功

![](image_JLUuH_5wkx.png)
...
![](image_7_Rqhxn7DX.png)

​ 安装成功后在/usr/local/redis/bin目录下可以看到如下结构。

![](image_Bt-xQWsvye.png)
...
![](image_8PaXMwFRuu.png)

![](image_qDmTAC2lFr.png)

![](image_exVyGAAW71.png)
