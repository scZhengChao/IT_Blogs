...
![](image_GwXAfzUKjZ.png)

![](image__0TsuUPWsv.png)
...
![](image_BbC4Wj4N4e.png)

![](image_rLER1kEXxO.png)

![](image_tB693vhrwO.png)

1. 通过./redis-server redis.conf启动服务器，在服务器目录下出现appendonly.aof文件。大小是0个字节。

![](image_D_5HiXGbnO.png)

![](image_rmC1HS1Dm3.png)

1. 添加3个键和值

![](image_sUBQwg8PR_.png)

1. 打开appendonly.aof文件，查看文件的变化。会发现文件记录了所有操作的过程。

![](image_71SgtWWMvv.png)

![](image_97lPQyPZim.png)
