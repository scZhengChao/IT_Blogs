...
- [初期的 MySQL 存储方案](#初期的-MySQL-存储方案)
- [遭遇瓶颈，寻找解决方案](#遭遇瓶颈寻找解决方案)
- [技术转身，使用 TiDB](#技术转身使用-TiDB)

[https://pingcap.com/docs-cn/stable/](https://pingcap.com/docs-cn/stable/ "https://pingcap.com/docs-cn/stable/")
...
![  ](./assets/image/5f9a7b98e0e37f4e5477eaa50b9ae159_btkzCeuZER.webp "  ")
...
![  ](./assets/image/777caaeb4386ed671cfe761e895340e6_EJgx9bD_cO.webp "  ")
...
![  ](./assets/image/e20a57ba4d4d2a5fabdd194ff4185e93_WHUpW31BN8.webp "  ")
...
3. 当前我们正在着手把 storm 集群上的 BI 系统的实时计算业务的数据存储系统从 MongoDB 替换成 TiDB（因 MongoDB 的使用门槛相对较高，运维成本大，查询方式不如传统的 SQL 灵活），后续也计划把实时性要求高、数据存储量大且存储周期较长的业务都迁移到 TiDB 上来，看上去是一个比较合适的场景。
