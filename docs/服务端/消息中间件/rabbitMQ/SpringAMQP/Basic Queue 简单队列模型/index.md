...
![](./image/image_AYCmyI0KFz.png)

### 消息发送

> 注意：整个过程一定保证mq的容器是启动的

![](./image/image_DsegbXWLNq.png)

【1】首先配置MQ地址，在publisher服务的application.yml中添加配置：

![](./image/image_eQbKMi48ir.png)
...
![](./image/image_s371ZFPsmA.png)

![](./image/image_LPhZcGshGG.png)
