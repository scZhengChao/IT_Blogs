...
- [复习要点](#复习要点)
- [正文](#正文)
  - [1、为什么要使用消息队列?](#1为什么要使用消息队列)
    - [(1)解耦](#1解耦)
    - [(2)异步](#2异步)
    - [(3)削峰](#3削峰)
  - [2、使用了消息队列会有什么缺点?](#2使用了消息队列会有什么缺点)
  - [3、消息队列如何选型?](#3消息队列如何选型)
  - [4、如何保证消息队列是高可用的？](#4如何保证消息队列是高可用的)
  - [5、如何保证消息不被重复消费？](#5如何保证消息不被重复消费)
  - [6、如何保证消费的可靠性传输?](#6如何保证消费的可靠性传输)
    - [RabbitMQ](#RabbitMQ)
    - [kafka](#kafka)
    - [ActiveMQ和RocketMQ](#ActiveMQ和RocketMQ)
  - [7、如何保证消息的顺序性？](#7如何保证消息的顺序性)
- [ 一些其他的相关连接：](#一些其他的相关连接)
...
1. 为什么使用[消息队列](https://blog.csdn.net/alinshen/article/details/80583214 "消息队列")？
2. 使用消息队列有什么缺点?
3. [消息队列](https://blog.csdn.net/alinshen/article/details/80583214 "消息队列")如何选型?
4. 如何保证消息队列是高可用的？
5. 如何保证消息不被重复消费?
6. 如何保证消费的可靠性传输?
7. 如何保证消息的顺序性？
...
### **1、为什么要使用**[**消息队列**](https://blog.csdn.net/alinshen/article/details/80583214 "消息队列")**?**
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_jieou5_obfTiD-9Bf.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_jieou6_W_ccyvPUfn.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_yibu2_oz9MSjqGEi.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_yibu3_uQviUqVvjG.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_xuefeng1_SGgby6pySN.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_xuefeng2_oCJXGSUIXK.webp "  ")
...
回答:首先，咱先上[ActiveMQ的社区](http://activemq.apache.org/ "ActiveMQ的社区")，看看该MQ的更新频率:
...
接下来，我们再去[RabbitMQ的社区](http://www.rabbitmq.com/ "RabbitMQ的社区")去看一下,RabbitMQ的更新频率
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_rocketcluster_lfnoGrZxSD.webp "  ")
...
![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_kafka_vzWrQUl1MM.webp "  ")
...
这里先引一张kafka Replication的

[数据流向图](http://www.infoq.com/cn/articles/kafka-analysis-part-2/ "数据流向图")

![  ](../assets/关于ActiveMQ、RocketMQ、RabbitMQ、K/image/o_kafka1png_1GLg2JJKj3.webp "  ")
...
[RabbitMQ基础概念详细介绍](https://www.cnblogs.com/williamjie/p/9481774.html "RabbitMQ基础概念详细介绍")

<https://blog.csdn.net/anzhsoft/article/details/19563091  >

RabbitMQ消息队列

<https://segmentfault.com/a/1190000016351345 > <https://blog.csdn.net/qq_26656329/article/details/77891793 >&#x20;
