...
![](./assets/image/image_LOJaNAuQNy.webp)
...
![](./assets/image/image_aOuf_yryfP.webp)
...
![](./assets/image/image_H0g3Oy7yvT.webp)
...
![](./assets/image/image_fH8uIlkOTk.webp)

浏览器向服务器发送一个 **SYNC** 消息，要求进行同步（同步意味着连接）

![](./assets/image/image_JtpB4uedHI.webp)

然后，服务器将回复一个 **SYNC-ACK** 消息（ SYNChronization 和 ACKnowledgement）

![](./assets/image/image_KZ7zDDh-bu.webp)
...
![](./assets/image/image_0DS-3smNcN.webp)
