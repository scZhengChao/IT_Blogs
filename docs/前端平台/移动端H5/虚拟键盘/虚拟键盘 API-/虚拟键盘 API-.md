...
![](image_9Lk8Ckt1Xw.png)

当输入框处于激活状态时，`checkout` 按钮将位于虚拟键盘下方，因此它被隐藏了。

![](image_CNS2ajGFkB.png)
...
![](image_rb3ET1vtW4.png)

#### 浮动操作按钮

在页面右下角有一个浮动操作按钮。

![](image_n_vkptw3iX.png)
...
![](image_ka0Ao0Sjuu.png)

### 聊天布局

先来看下面的图：

![](image_XVTAxKYiw4.png)
