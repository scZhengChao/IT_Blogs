...
[Listen for events with ipcMain.on](<./ipcMain事件监听/index.md> "Listen for events with ipcMain.on")

[通过预加载脚本暴露 ipcRenderer.send](<./预加载暴露send/index.md> " 通过预加载脚本暴露 ipcRenderer.send")
